...
- 书籍测评功能（答题、成绩查看、奖状）
- 书架管理（书籍列表、书籍详情）
- 个人中心（我的阅读、积分明细、我的等级、我的奖状、阅读能力图谱、用户反馈）
- 个人信息管理
- 消息中心与资讯浏览
- 班级广场与班级排行榜
- 用户反馈（反馈提交、反馈记录）
...
| 4    | F022 | 登录与账户 | 个人信息编辑       | 头像上传、姓名编辑、学校选择、班级选择、手机号绑定、微信服务通知 | P1     | 待开发 | 13-个人信息编辑 |
...
展示用户个人信息、阅读能力图谱预览，以及用户反馈、退出登录等功能入口
...
5. 用户反馈入口展示在功能菜单中，点击跳转至F031用户反馈页面
6. 联系我们点击弹出企业微信二维码弹窗，二维码图片由管理后台上传配置
7. 点击“退出登录”按钮后弹出二次确认弹窗，确认后清除本地登录态并返回登录页
8. 用户首次进入“我的”时弹出一次消息通知引导弹窗，用户可直接选择是否开启，后续可在个人信息编辑页打开或关闭
...
| 功能菜单     | List（列表）  | 我的阅读、我的打卡、我的奖状、我的测评、用户反馈、联系我们，每项右侧显示数据摘要 |
...
3. 积分和等级实时更新
4. 能力图谱卡片数据正确
5. 用户反馈入口展示正常并可跳转到反馈页面
6. 联系我们弹窗正常弹出和关闭
7. 点击退出登录可正常唤起确认弹窗，确认后返回登录页
8. 首次进入“我的”时正确弹出消息通知引导
