...
| F037 | AI导读视频 | P1     | 待开发 | 横屏视频播放，完整观看后获得积分                                      |
...
| F011 | 打卡成功   | P0     | 待开发 | 成功动画、奖励展示、参考答案                                          |
...
| F025 | 我的等级   | P1     | 待开发 | 等级展示、升级进度、全部等级列表                 |
