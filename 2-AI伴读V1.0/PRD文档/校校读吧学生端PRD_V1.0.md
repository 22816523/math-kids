...
| F009 | AI导语     | P1     | 待开发 | AI生成的书籍导读，含任务清单、导读视频入口、跳过操作 |
...
**功能说明：**
展示阅读日历和当前阅读计划的今日任务，日历直观呈现每日任务完成情况，引导用户进入AI导语页完成任务
...
| 今日任务      | Text（文本）   | 显示今日任务数量，如"今日共4个任务"                                                    |
...
| 导语气泡     | Text（文本）       | AI生成的任务引导文字，左侧蓝色边框装饰                               |
...
| 37   | 07-1-AI导读视频.html           | AI导读视频     | F037         | 首页模块     |
| 38   | 07-1-AI导读视频-测试题.html    | AI导读视频测试题 | F037       | 首页模块     |
| 39   | 07-1-AI导读视频-退出.html      | AI导读视频退出确认 | F037     | 首页模块     |
